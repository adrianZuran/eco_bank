        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            @if(auth()->user()->role == 'admin')
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 flex flex-col items-center py-10">
                        <h3 class="text-2xl font-bold mb-4">Selamat Datang di Eco Bank, {{ auth()->user()->name }}!</h3>
                        <p class="mb-6 text-gray-600 text-center max-w-lg">Anda login sebagai <strong>Administrator</strong>. Anda memiliki hak akses penuh untuk mengelola dan mengonfirmasi setiap transaksi setor sampah dari para nasabah.</p>
                        <a href="{{ route('admin.index') }}" class="inline-block bg-blue-600 text-white font-semibold px-6 py-3 rounded-lg shadow hover:bg-blue-700 transition-colors">
                    ...
                    <div class="bg-gradient-to-r from-[#3F6A28] to-[#4A7F2F] rounded-[2rem] p-8 sm:p-10 text-white shadow-xl relative overflow-hidden">
                        ...
                        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center relative z-10">
                            ...
                            <div class="mt-8 sm:mt-0 flex gap-3 w-full sm:w-auto">
                                ...
                                <button class="flex-1 sm:flex-none px-6 py-3 bg-white text-[#3F6A28] rounded-xl text-sm font-bold tracking-wide hover:bg-gray-100 shadow-md transition text-center whitespace-nowrap">+ Setor Sampah</button>
                            </div>
                        </div>
                    </div>
